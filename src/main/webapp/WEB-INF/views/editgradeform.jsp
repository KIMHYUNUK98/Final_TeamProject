<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@page import="com.my.app.board.GradeDAO, com.my.app.board.GradeVO"%>
            ...
            <div class="col-sm-10 w3-margin-top w3-margin-bottom">
                ...
                <div class="w3-white w3-text-black w3-card-4 w3-round-large" style="width:100%; height: 100%;">
		                     <div class="w3-card-2 w3-round-large">
		                         ...
		                         <form:form class="w3-container" commandName="gradeVO" action="../editok" method="post">
		                         	<form:hidden path="seq" />
			                           <p>
			                           <form:input class="w3-input w3-margin-top" path="member"/>
			                           <label>Name (사용자 이름)</label>
			                           </p>
			                           <p>
			                           <form:input class="w3-input w3-margin-top" path="title"/>
			                           <label>Title (수업 이름)</label>
			                           </p>      
			                           <p>
			                           <label>Period (교시)</label>
			                           <form:radiobutton path="period" value="1"/>
										<label>1</label>
										<form:radiobutton path="period" value="2"/>
										<label>2</label>
										<form:radiobutton path="period" value="3"/>
										<label>3</label>
										<form:radiobutton path="period" value="4"/>
										<label>4</label>
										<form:radiobutton path="period" value="5"/>
										<label>5</label>
										<form:radiobutton path="period" value="6"/>
										<label>6</label>
										<form:radiobutton path="period" value="7"/>
										<label>7</label>
										<form:radiobutton path="period" value="8"/>
										<label>8</label>
										<form:radiobutton path="period" value="9"/>
										<label>9</label>
			                           ...
			                           <form:textarea cols="50" rows="5" path="content" style="resize: none;" />
			                           
			                           <p>
			                           
			                           </p>
			                     <p><button class="w3-btn w3-round-large w3-black w3-margin-top w3-margin-left" type="submit">EDIT POST</button>
