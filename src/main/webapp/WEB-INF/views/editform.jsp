		            ...
		            <form:form commandName="boardVO" method="POST" action="../editok">
					   <form:hidden path="seq"/>		               
		                   <div class="w3-margin-left w3-margin-right">
	                           <p>
	                           <form:input class="w3-input w3-margin-top" type="text" name="category" path="category"/>
	                           <label>Category (카테고리)</label>
	                           </p>
	                           <p>
	                           <form:input class="w3-input w3-margin-top" type="text" name="title" path="title" />
	                           <label>Title (제목)</label>
	                           </p>      
	                           <p>
	                           <form:input class="w3-input w3-margin-top" type="text" name="writer" path="writer" />
	                           <label>Writer (작성자)</label>
	                           </p>
	                           <p>   
	                           <form:input class="w3-input w3-margin-top" type="text" name="content" path="content" />
	                           <label>Content (내용)</label>
	                           </p>
			                   <p><button class="w3-btn w3-round-large w3-black w3-margin-top w3-margin-left">Edit Complete</button>
			                   <button class="w3-btn w3-round-large w3-red w3-margin-top w3-margin-left" onclick="history.back()">Cancel</button></p>
						</div>
					</form:form>		
         		</div>
    	 	</div>
