            ...
            <div class="col-sm-10 w3-margin-top w3-margin-bottom">
                ...
                <div class="w3-white w3-text-black w3-card-4 w3-round-large" style="width:100%; height: 100%;">
		                     <div class="w3-card-2 w3-round-large">
			                     ...
			                     <p><button class="w3-btn w3-round-large w3-black w3-margin-top w3-margin-left">ADD NEW POST</button>
			                     <button class="w3-btn w3-round-large w3-black w3-margin-top w3-margin-left" onclick="location.href='main'">Go Main</button></p>
			                     </form>
			                     </div>
